...
class QuotesView(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.search_entry = ctk.CTkEntry(top_frame, placeholder_text="🔎 BUSCA: PLACA, CLIENTE OU STATUS...", height=40,
        ...
        btn_new = ctk.CTkButton(top_frame, text="[ NOVO ORÇAMENTO ]", command=self.new_quote, **theme.btn_primary())
        ...
        btn_convert = ctk.CTkButton(top_frame, text="[ CONVERTER EM OS ]", command=self.convert_to_os, **theme.btn_success())
