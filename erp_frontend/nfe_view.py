...
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
    ...
    def reset_state(self):
        ...
        for item in self.table.get_children(): self.table.delete(item)
<<<<<<< HEAD
        self.lbl_fornecedor.configure(text="FORNECEDOR: --", text_color=theme.TEXT_MUTED)
        self.lbl_chave.configure(text="CHAVE: --", text_color=theme.TEXT_MUTED)
        self.lbl_totais.configure(text="EMISSÃO: --  |  TOTAL: --", text_color=theme.TEXT_MUTED)
        self.btn_simulate.configure(state="disabled")
        self.btn_import.configure(state="disabled")
=======
