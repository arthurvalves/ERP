...
=======
        ctk.CTkLabel(top_frame, text="Relatório de Produtividade por Técnico", font=("Roboto", 20, "bold")).pack(side="left")
...
=======
        ctk.CTkLabel(date_frame, text="De:", font=("Roboto", 12)).pack(side="left", padx=(10, 5))
        self.prod_start_date = ctk.CTkEntry(date_frame, width=100, font=("Roboto", 12))
        self.prod_start_date.insert(0, start_of_month.strftime('%d/%m/%Y'))
        self.prod_start_date.pack(side="left")

        ctk.CTkLabel(date_frame, text="Até:", font=("Roboto", 12)).pack(side="left", padx=(10, 5))
        self.prod_end_date = ctk.CTkEntry(date_frame, width=100, font=("Roboto", 12))
        self.prod_end_date.insert(0, today.strftime('%d/%m/%Y'))
        self.prod_end_date.pack(side="left")

        btn_generate = ctk.CTkButton(date_frame, text="GERAR", command=self.load_productivity_report)
        btn_generate.pack(side="left", padx=10)
...
=======
        ctk.CTkLabel(top_frame, text="Lista de Produtos com Estoque Baixo", font=("Roboto", 20, "bold")).pack(side="left")
        btn_refresh = ctk.CTkButton(top_frame, text="ATUALIZAR LISTA", command=self.load_suggestions_report)
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
...
=======
        self.suggestions_table.tag_configure("critical", foreground="#e74c3c")
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
...
=======
        ctk.CTkLabel(top_frame, text="Relatório de Vendas por Período", font=("Roboto", 20, "bold")).pack(side="left")
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
...
=======
        ctk.CTkLabel(date_frame, text="De:", font=("Roboto", 12)).pack(side="left", padx=(10, 5))
        self.sales_start_date = ctk.CTkEntry(date_frame, width=100, font=("Roboto", 12))
        self.sales_start_date.insert(0, start_of_month.strftime('%d/%m/%Y'))
        self.sales_start_date.pack(side="left")

        ctk.CTkLabel(date_frame, text="Até:", font=("Roboto", 12)).pack(side="left", padx=(10, 5))
        self.sales_end_date = ctk.CTkEntry(date_frame, width=100, font=("Roboto", 12))
        self.sales_end_date.insert(0, today.strftime('%d/%m/%Y'))
        self.sales_end_date.pack(side="left")

        btn_generate = ctk.CTkButton(date_frame, text="GERAR", command=self.load_sales_report)
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
        btn_generate.pack(side="left", padx=10)
...
=======
        ...
        # Adiciona uma linha de total no final
        self.productivity_table.insert("", "end", values=("---", "---", "---"))
        self.productivity_table.insert("", "end", values=("TOTAL GERAL", "", f"R$ {total_geral:.2f}"), tags=("total",))
        self.productivity_table.tag_configure("total", font=("Roboto", 14, "bold"), foreground="#2ecc71")
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
...
=======
            suggestion_qty = max(0, suggestion_qty) # Garante que não seja negativo
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
...
=======
        self.sales_table.tag_configure("total", font=("Roboto", 14, "bold"), foreground="#2ecc71")
>>>>>>> b8696156ad077242d2bbfc43a202beb2b9ea5c18
